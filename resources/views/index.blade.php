<x-layout>
    ...
    <section class="">
        <div class="bg-cyan-600 text-white py-16 text-center rounded-sm">
            <h1 class="text-4xl font-bold">Welcome to Blog</h1>
            <p class="mt-2 text-lg">Explore articles, tutorials, and tech insights.</p>
            <a href="/posts"
                class="mt-4 inline-block bg-white text-cyan-600 font-semibold px-6 py-2 rounded-full hover:bg-gray-200">
                View Posts
            </a>
        </div>
